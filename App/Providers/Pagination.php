...
//        echo "after: $after <br>";
        ...
        if ($prevAndNext)                                                       // Go first page
            $list .= "<li><a rel='nofollow' href='$link$firstPage'><i class='fas fa-angle-double-left'></i></a></li>";
        for ($i = $before; $i <= $after; $i++) {
            if ($i == $currentIndex)
                $list .= "<li><a rel='nofollow' class='active' href='$link$i'>$i</a></li>";    // Current Page
            else
                $list .= "<li><a rel='nofollow' rel='nofollow' href='$link$i'>$i</a></li>";                   // Other Pages
        }
        if ($prevAndNext)                                                       // Go last page
            $list .= "<li><a rel='nofollow' href='$link$lastPage'><i class='fas fa-angle-double-right'></i></a></li>";
        $list .= '</ul>';
